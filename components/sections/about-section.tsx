      ...
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
            Pembekalan Prodiakon 5 Juli 2025
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Maksud dan tujuan Pembekalan Prodiakon 5 Juli 2025 adalah sebagai sarana menambah wawasan dan pengetahuan
            dalam pelayanan sebagai seorang prodiakon/prodiakones.
          </p>
          {/* <p className="mt-4 text-lg text-muted-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-background rounded-lg p-6 shadow-sm">
            ...
            <p className="text-muted-foreground">Skedul pelaksanaan Tanggal 5 Juli 2025.</p>
          </div>
